...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx1_time_passed_kin, gx1_angles_kin[0], label="$\phi_{kin}$")
plt.plot(gx1_time_passed_kin, gx1_angles_kin[1], label=r"$\theta_{kin}$")
plt.plot(gx1_time_passed_kin, gx1_angles_kin[2], label="$\psi_{kin}$")
plt.plot(gx1_time_passed, gx1_angles[0], '--', label=r"$\phi_{quat}$")
plt.plot(gx1_time_passed, gx1_angles[1], '--', label=r"$\theta_{quat}$")
plt.plot(gx1_time_passed, gx1_angles[2], '--', label="$\psi_{quat}$")
plt.grid(True)
