...
plt.subplot(111)
plt.plot(f1_data[0], f1_data[1], label="x", color = color_tab[0])
plt.plot(f1_data[0], f1_data[2], label="y", color = color_tab[1])
plt.plot(f1_data[0], f1_data[3], label="z", color = color_tab[2])
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(f2_data[0], f2_data[4], label="oś x", color = color_tab[0])
plt.plot(f2_data[0], f2_data[5], label="oś y", color = color_tab[1])
plt.plot(f2_data[0], f2_data[6], label="oś z", color = color_tab[2])
plt.grid(True)
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx1_data[0], gx1_data[1], label="oś x", color = color_tab[0])
plt.plot(gx1_data[0], gx1_data[2], label="oś y", color = color_tab[1])
plt.plot(gx1_data[0], gx1_data[3], label="oś z", color = color_tab[2])
plt.grid(True)
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx1_data[0], gx1_converted[0], label="oś x", color = color_tab[0])
plt.plot(gx1_data[0], gx1_converted[1], label="oś y", color = color_tab[1])
plt.plot(gx1_data[0], gx1_converted[2], label="oś z", color = color_tab[2])
plt.grid(True)
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx2_data[0], gx2_data[1], label="oś x", color = color_tab[0])
plt.plot(gx2_data[0], gx2_data[2], label="oś y", color = color_tab[1])
plt.plot(gx2_data[0], gx2_data[3], label="oś z", color = color_tab[2])
plt.grid(True)
plt.title("Wykres odczytanych wartości na 3DM-GX2 w funkcji czasu (składowa \"$a$\").")
plt.ylabel(r"$\frac{a}{g} \left [ - \right ]$")
plt.xlabel("t [s]")
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx2_data[0], gx2_converted[0], label="oś x", color = color_tab[0])
plt.plot(gx2_data[0], gx2_converted[1], label="oś y", color = color_tab[1])
plt.plot(gx2_data[0], gx2_converted[2], label="oś z", color = color_tab[2])
plt.grid(True)
plt.title("Wykres odczytanych wartości na 3DM-GX2 w funkcji czasu (składowa \"$\omega$\").")
plt.ylabel(r"$\omega \left [ \frac{^\circ}{s} \right ]$")
plt.xlabel("t [s]")
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx1_time_passed, gx1_angles[0], label="$\phi$", color = color_tab[0])
plt.plot(gx1_time_passed, gx1_angles[1], label=r"$\theta$", color = color_tab[1])
plt.plot(gx1_time_passed, gx1_angles[2], label="$\psi$", color = color_tab[2])
plt.grid(True)
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx1_time_passed_kin, gx1_angles_kin[0], label="$\phi$", color = color_tab[0])
plt.plot(gx1_time_passed_kin, gx1_angles_kin[1], label=r"$\theta$", color = color_tab[1])
plt.plot(gx1_time_passed_kin, gx1_angles_kin[2], label="$\psi$", color = color_tab[2])
plt.grid(True)
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx1_time_passed_kin, gx1_angles_kin[0], label="$\phi_{kin}$", color = color_tab[0])
plt.plot(gx1_time_passed_kin, gx1_angles_kin[1], label=r"$\theta_{kin}$", color = color_tab[1])
plt.plot(gx1_time_passed_kin, gx1_angles_kin[2], label="$\psi_{kin}$", color = color_tab[2])
plt.plot(gx1_time_passed, gx1_angles[0], '--', label=r"$\phi_{quat}$", color = color_tab[0])
plt.plot(gx1_time_passed, gx1_angles[1], '--', label=r"$\theta_{quat}$", color = color_tab[1])
plt.plot(gx1_time_passed, gx1_angles[2], '--', label="$\psi_{quat}$", color = color_tab[2])
plt.grid(True)
plt.title("Porównanie wykresów kątów obliczonych obiema metodami")
plt.ylabel(r"kąt $\left [ ^\circ \right ]$")
plt.xlabel("t [s]")
plt.legend(loc = "lower right")
plt.savefig("output/3DM-GX2_2_ang_porownianie.png")
...
plt.figure(figsize = (25/2.54, 20/2.54))
plt.subplot(111)
plt.plot(gx2_time_passed_kin, gx2_angles_kin[0], label="$\phi_{kin}$")
plt.plot(gx2_time_passed, gx2_angles[0], label=r"$\phi_{quat}$")
plt.grid(True)
plt.title(r"Porównanie wykresów kąta $\phi$ obliczonego metodą kinematyczną i kwaternionową dla ruchu swobodnego.")
plt.ylabel(r"kąt $\left [ ^\circ \right ]$")
plt.xlabel("t [s]")
plt.legend(loc = "lower right")
